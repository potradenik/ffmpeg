...
// Аутентификация Google Drive – исправленная версия
let privateKey = process.env.GOOGLE_PRIVATE_KEY || '';
// Убираем возможные кавычки, которые могли быть добавлены при копировании
privateKey = privateKey.replace(/^"|"$/g, '');
// Заменяем экранированные \n на реальные переносы (на случай, если ключ вставлен одной строкой)
